            ...
            <div class="lg:w-6/12 px-4 md:px-0">
              <div class="md:p-12 md:mx-6">
                <div class="text-center">
                  ...
                  <h4 class="text-xl font-semibold mt-1 mb-12 pb-1">Welcome! To My Site.</h4>
                </div>
                @if(\Session::has('message'))
                  <div role="alert">
                    <div class="bg-red-500 text-white font-bold rounded-t px-3 py-1">
                      Danger
                    </div>
                    <div class="border border-t-0 border-red-400 rounded-b bg-red-100 px-4 py-3 text-red-700">
                      <p></p>{{\Session::get('message')}}
                    </div>
                  </div>
                @endif
                <form method="POST" action="{{ route('postlogin') }}">
                  ...
                  <div class="flex items-center justify-between pb-6">
                    ...
                    <a class="inline-block px-6 py-2 border-2 border-red-600 text-red-600 font-medium text-xs leading-tight uppercase rounded hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out"
                      data-mdb-ripple="true"
                      data-mdb-ripple-color="light"
                      href="{{ route('register-user')}}">Register here.</a>
                  </div>
                </form>
              </div>
            </div>
